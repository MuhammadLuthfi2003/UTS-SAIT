...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 13, 2023 at 09:18 AM
...
--
ALTER TABLE `perkuliahan`
  MODIFY `id_perkuliahan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `perkuliahan`
  ADD CONSTRAINT `fk_matakuliah` FOREIGN KEY (`kode_mk`) REFERENCES `matakuliah` (`kode_mk`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `fk_nim` FOREIGN KEY (`nim`) REFERENCES `mahasiswa` (`nim`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
